This is the README for Sci-Fi Weapons - Base Pack.
You can purchase the other versions of this pack from Dev Assets.

-- INSTRUCTIONS --

If you are using Unity and want to get up an running right away you can open the "Sci-Fi Weapons (Base Pack).unitypackage" which also comes with an Example Scene.
